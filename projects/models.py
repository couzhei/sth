...
class Project(models.Model):  # we inherit from django's model.Model class
    ...
    tags = models.ManyToManyField('Tag', blank=True)  # try unquoting this Tag and this will raise an error due to not defining the Tag variable
...
class Review(models.Model):
    ...
    value = models.CharField(max_length=200, choices=VOTE_TYPE) # choices makes the dropbox
    created = models.DateTimeField(auto_now_add=True)
